...
public class HttpCilent implements WebCilent
{
	...
	public HttpCilent(String host) throws UnknownHostException, WebCilentException
	{
		this.setHost(host);
	}
	
	public HttpCilent(String host, String ipAddr) throws WebCilentException
	{
		this.setHost(host, ipAddr);
	}
	
	public HttpCilent(String host, InetAddress ipAddr) throws WebCilentException
	{
		this.setHost(host, ipAddr);
	}
	
	public HttpCilent(String host, int port) throws UnknownHostException, WebCilentException
	{
		this.setHost(host);
		this.webSocket.setPort(port);
	}
	
	public HttpCilent(String host, String ipAddr, int port) throws WebCilentException
	{
		this.setHost(host, ipAddr);
		this.webSocket.setPort(port);
	}
	
	public HttpCilent(String host, InetAddress ipAddr, int port) throws WebCilentException
	{
		this.setHost(host, ipAddr);
		this.webSocket.setPort(port);
	}
	...
	public void setHost(String host) throws WebCilentException
	{
		...
		{
			e.printStackTrace();
			throw new WebCilentException("Create socket error!\r\nFunction: public HttpCilent(String host) throws UnknownHostException",
	...
	{
		return HttpCilent.defaultAccept;
	}

	@Override
	public void setDefaultAccept(String defaultAccept)
	{
		HttpCilent.defaultAccept = defaultAccept;
	}

	@Override
	public String getDefaultAcceptLanguage()
	{
		return HttpCilent.defaultAcceptLanguage;
	}

	@Override
	public void setDefaultAcceptLanguage(String defaultAcceptLanguage)
	{
		HttpCilent.defaultAcceptLanguage = defaultAcceptLanguage;
	}
